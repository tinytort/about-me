...
function favoriteBreedsQuestion() {
...
dogQuestion();
popsicleQuestion();
favoriteBreedsQuestion();



console.log('Your score is ' + correctAnswer + ' out of 7, ' + name + '. Thanks for playing!');
alert('Your score is ' + correctAnswer + ' out of 7, ' + name + '. Thanks for playing!');
